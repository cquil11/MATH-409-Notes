...
\begin{itemize}
    ...
    \begin{theorem}[Intermediate Value Theorem]
        ...
        \caution \textbf{Caution}: $y_0$ may not be unique.
    \end{theorem}
    \begin{proof}
    ...
    \end{proof}
    \item \caution \textbf{Warning}: If $f: [a, b] \mapsto \R$ such that $f(a) < f(b)$ and $\forall y_0 \in \R$ with $f(a) < y_0 < f(b) \implies \exists x_0 \in (a, b)$ with $f(x_0) = y_0$
